...
public class Main {
    public static void main(String[] args) {
        ...
        //Creamos un Scanner para leer los datos de entrada
            ...
            switch (opcion) {
                ...
                case "7":
                    ...
                    try {
                        ...
                        String csvFile = "C:\\Isla\\2DAM\\1ºT\\Acceso a datos\\Hito\\MySQL-HitoIndividual-AcesoDatos-IslaP\\MySQL-HitoIndividual-AcesoDatos-IslaP\\CSV\\datos.csv";
                ...
                case "8":
                    ...
                    try {
                        ...
                        rs.beforeFirst();
                        //Creo un fichero CSV indicandole la ruta donde se va a guardar
                        String csvFile = "C:\\Isla\\2DAM\\1ºT\\Acceso a datos\\Hito\\MySQL-HitoIndividual-AcesoDatos-IslaP\\MySQL-HitoIndividual-AcesoDatos-IslaP\\CSV\\productos.csv";
                        try (BufferedWriter bw = new BufferedWriter(new FileWriter(csvFile))) {
                            //Mientras haya datos en la tabla productos
                            while (rs.next()) {
                ...
                case "9":
                    ...
                    try {
                        ...
                        rs.beforeFirst();
                        //Creo un fichero CSV indicandole la ruta donde se va a guardar
                        String csvFile = "C:\\Isla\\2DAM\\1ºT\\Acceso a datos\\Hito\\MySQL-HitoIndividual-AcesoDatos-IslaP\\MySQL-HitoIndividual-AcesoDatos-IslaP\\CSV\\marcas.csv";
                        try (BufferedWriter bw = new BufferedWriter(new FileWriter(csvFile))) {
